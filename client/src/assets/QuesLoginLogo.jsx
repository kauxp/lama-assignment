...
const QuesLoginLogo = (props) => {
    return (
        <svg width={props.width ||"106"} height={props.height || "107"} viewBox="0 0 106 107" fill="none" xmlns="http://www.w3.org/2000/svg " style={{ marginTop: props.marginTop || '0' }} >
